...
import 'package:movie/resources/similar_api_provider.dart';

import 'detail_movie_screen.dart';

class SimilarMovie extends StatefulWidget {
  final int id;
  SimilarMovie({@required this.id});

  @override
  _SimilarMovieState createState() => _SimilarMovieState();
}
...
class _SimilarMovieState extends State<SimilarMovie> {
  ...
  void _getData() async {
    SimilarApiProvider().fetchSimilarMovies(widget.id,pageNo.toString()).then((value) {
      setState(() {
